...
//     let myDiv = select('.item-1'); // Select the div with the id "myDiv"
    
//     // Event listener for when the mouse is over the div
//     myDiv.mouseOver(changeText);
    
 
//     // Event listener for when the mouse leaves the div
//     myDiv.mouseOut(restoreText);
  
//   }
  
//   function draw() {
//     if (mouseIsPressed) {
//         let myParagraph = select('#text-8');

//   myParagraph.html('Hello, p5.js!');
//     } else {
//       fill(255);
//     }
...
//   function changeText() {
//     // Change the text when the mouse is over the div
//     this.html('Mouse Over!');
//   }

//   function restoreText() {
//     // Restore the original text when the mouse leaves the div
//     this.html('THE DISTORTED TIMES');
//   }



//https://codemyui.com/ios-invisible-ink-on-websites/
(function(){
	jQuery(document).ready(function(){
		$('#text-8').mousemove(function(e){
		  var rXP = (e.pageX - this.offsetLeft-$(this).width()/2);
		  var rYP = (e.pageY - this.offsetTop-$(this).height()/2);
		  $('#text-8').css('text-shadow', +rYP/10+'px '+rXP/80+'px rgba(255,0,0,.8), '+rYP/8+'px '+rXP/60+'px rgba(0,255,0,1), '+rXP/70+'px '+rYP/12+'px rgba(0,0,255,.7)');
		});
	 });
